...
$filters_tip = count($filters) ? TEXT_EXAMPLE . ': ' . implode(', ', $filters):'';
    ...
    case 'php':
        ...
        $html .= '
            <div class="form-group">
                ...
                <div class="col-md-9">' . textarea_tag('settings[php_code]',$settings->get('php_code'),['class'=>'code_mirror','mode'=>'php']) 
                . tooltip_text(
                        TEXT_EXAMPLE . ': <code>$output_value = "my value' . htmlspecialchars('<br>'). 'next line";</code><br>' 
                        . TEXT_EXAMPLE . ': <code>$output_value = $item["field_13"]>0 ? 1:0;</code><br>' 
                        . TEXT_EXAMPLE . ': <code>$output_value = "my value ' . htmlspecialchars('<b>') . 'bold line' . htmlspecialchars('</b>') . '";</code><br>'
                        . $filters_tip
                        ) . '</div>			
            </div>
