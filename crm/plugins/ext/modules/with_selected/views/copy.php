...
<?php echo form_tag('form-copy-to', url_for('ext/with_selected/copy', 'action=copy_selected&reports_id=' . $_GET['reports_id'] . '&path=' . $app_path), array('class' => 'form-horizontal')) ?>
