...
echo form_tag('export_form', url_for('ext/with_selected/export','action=export_' . $template_info['type'] . '&templates_id=' . $template_info['id'] . '&path=' . $app_path),['class'=>'form-horizontal']) 
