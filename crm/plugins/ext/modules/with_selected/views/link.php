...
<?php echo form_tag('add_related_items', url_for('ext/with_selected/link','action=add_related_items&reports_id=' . _GET('reports_id') . '&path=' . $app_path), array('class'=>'form-horizontal')) ?>
